#!/usr/bin/env python3
"""
Fix Connections and Launch SUMO
Fixes the connections file and launches SUMO GUI with live comparison
"""
...
def fix_connections_and_launch():
    """Fix connections file and launch SUMO GUI"""
    print("🔧 Fixing Connections and Launching SUMO")
    print("=" * 50)
    
    # Create corrected node file
    print("📝 Creating corrected node file...")
...
<nodes xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://sumo.dlr.de/xsd/nodes_file.xsd">
    ...
    with open("fixed_nodes.nod.xml", 'w') as f:
        f.write(node_content)
    print("✅ Created: fixed_nodes.nod.xml")
    
    # Create corrected edge file
    print("📝 Creating corrected edge file...")
...
<edges xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://sumo.dlr.de/xsd/edges_file.xsd">
    ...
    with open("fixed_edges.edg.xml", 'w') as f:
        f.write(edge_content)
    print("✅ Created: fixed_edges.edg.xml")
    
    # Create corrected connection file (without state attribute)
    print("📝 Creating corrected connection file...")
...
<connections xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://sumo.dlr.de/xsd/connections_file.xsd">
    <connection from="north2center" to="center2south" fromLane="0" toLane="0"/>
    <connection from="north2center" to="center2east" fromLane="1" toLane="0"/>
    <connection from="north2center" to="center2west" fromLane="2" toLane="0"/>
    
    <connection from="east2center" to="center2west" fromLane="0" toLane="0"/>
    <connection from="east2center" to="center2north" fromLane="1" toLane="0"/>
    <connection from="east2center" to="center2south" fromLane="2" toLane="0"/>
    
    <connection from="south2center" to="center2north" fromLane="0" toLane="0"/>
    <connection from="south2center" to="center2east" fromLane="1" toLane="0"/>
    <connection from="south2center" to="center2west" fromLane="2" toLane="0"/>
    
    <connection from="west2center" to="center2east" fromLane="0" toLane="0"/>
    <connection from="west2center" to="center2north" fromLane="1" toLane="0"/>
    <connection from="west2center" to="center2south" fromLane="2" toLane="0"/>
</connections>"""
    
    with open("fixed_connections.con.xml", 'w') as f:
        f.write(connection_content)
    print("✅ Created: fixed_connections.con.xml")
    ...
    try:
        ...
        netconvert_cmd = [
            netconvert_binary,
            "--node-files", "fixed_nodes.nod.xml",
            "--edge-files", "fixed_edges.edg.xml", 
            "--connection-files", "fixed_connections.con.xml",
            "--output-file", "fixed_network.net.xml"
        ]
        ...
        if result.returncode == 0:
            print("✅ Network created successfully: fixed_network.net.xml")
        else:
...
<routes xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://sumo.dlr.de/xsd/routes_file.xsd">
    ...
    with open("fixed_routes.rou.xml", 'w') as f:
        f.write(routes_content)
    print("✅ Created: fixed_routes.rou.xml")
...
<configuration xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://sumo.dlr.de/xsd/sumoConfiguration.xsd">
    <input>
        ...
        <route-files value="fixed_routes.rou.xml"/>
    </input>
    ...
    with open("fixed_config.sumocfg", 'w') as f:
        f.write(config_content)
    print("✅ Created: fixed_config.sumocfg")
    
    print("\n🎉 Fixed SUMO network created successfully!")
    
    # Now launch SUMO GUI with live comparison
    print("\n🚀 Launching SUMO GUI with Live Comparison...")
    launch_sumo_with_comparison()

def launch_sumo_with_comparison():
    """Launch SUMO GUI with live comparison"""
    ...
    try:
        ...
        # Launch SUMO GUI
        config_file = "fixed_config.sumocfg"
        ...
        if sumo_process.poll() is None:
            ...
            start_live_comparison(sumo_process)
            return True
        else:
...
def start_live_comparison(sumo_process):
    """Start live comparison with video analysis"""
